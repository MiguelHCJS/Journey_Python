...
notas = [5, 7, 8, 9]
media = sum([x for x in notas]) / len(notas)
print(f'As notas são: {[x for x in notas]} com uma média de {media}')
...
numeroInteiros = [x for x in range(1, 21)]
print(f'{numeroInteiros}, quantidade: {len(numeroInteiros)}')
...
pares = [x for x in numeroInteiros if x % 2 == 0]
print(pares)
impares = [x for x in numeroInteiros if x % 2 != 0]
print(impares)
...
imprima o número de alunos com média maior ou igual a 7.0. (Melhorar)
"""

alunos = 10
notas_de_alunos = {}

def addLista(nome, t1, t2, t3, t4):
  notas_de_alunos[nome] = [t1, t2, t3, t4]
  # notas_de_alunos.append([nome, t1, t2, t3, t4])

while alunos > 0:
  nome = input('Nome do aluno: ')
  t1 = float(input('Nota do 1º trimestre: '))
  t2 = float(input('Nota do 2º trimestre: '))
  t3 = float(input('Nota do 3º trimestre: '))
  t4 = float(input('Nota do 4º trimestre: '))
  addLista(nome, t1, t2, t3, t4)
  alunos -= 1

notas = list(notas_de_alunos.items())
for x, y in notas:
  print(f'A média do aluno {x} é {sum(y) / len(y)}')
...
numeros_inteiros = [2, 6, 10, 20, 35]

print(f'Total da soma: {sum(numeros_inteiros)}')
for x, y in enumerate(numeros_inteiros, 1):
  # Soma
  print(f'Multiplicando os valores, de forma enumerada: \n {x} * {y}: {x * y}')
...
""" -- QUESTÃO 16 --
    ...
    De 100 em 100, de 200 até 1000, adiante.
