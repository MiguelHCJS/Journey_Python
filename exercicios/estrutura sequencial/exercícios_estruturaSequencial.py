...
''' -- QUESTÃO 1
Faça um Programa que mostre uma mensagem na tela.
'''
...
''' -- QUESTÃO 11 e 12
Tendo como dado de entrada a altura e peso da pessoa, construa um algoritmo que calcule seu peso ideal para homens e mulheres:
'''
